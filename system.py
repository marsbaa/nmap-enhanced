...
from query import OutputParser
...
class HostIface:
    ...
    def get_details_all_interfaces(self, *, skip_loopback: bool = True, refresh: bool = False) -> List[Any]:
        ...
        """
        details = []
        ifaces = self.get_alive_interfaces(
            skip_loopback=skip_loopback, refresh=refresh)
        for iface in ifaces:
    ...
    def get_iface_details(iface: str):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
            ...
            packed_netmask = fcntl.ioctl(
                s.fileno(), SIOCGIFNETMASK, iface_pack)[20:24]
